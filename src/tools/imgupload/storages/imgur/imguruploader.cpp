...
void ImgurUploader::upload()
{
    ...
    QUrl url(QStringLiteral("https://imgur-api-uploader-interop.112batman.com/3/image"));
                                ...
                                const QString& deleteToken)
{
    ...
    bool successful = QDesktopServices::openUrl(
      QUrl(QStringLiteral("https://imgur-api-uploader-interop.112batman.com/delete/%1").arg(deleteToken)));
    if (!successful) {
